...
# Copy built examples to nginx (served under /maplibre-gl-raster/ to match Vite base path)
...
echo ""\n\
echo "======================================================"\n\
echo "  MapLibre GL Raster Examples"\n\
echo "======================================================"\n\
echo ""\n\
echo "  Server running on port 80"\n\
echo ""\n\
echo "  If you ran: docker run -p 8080:80 ..."\n\
echo "  Open: http://localhost:8080/maplibre-gl-raster/"\n\
echo ""\n\
echo "======================================================"\n\
echo ""\n\
