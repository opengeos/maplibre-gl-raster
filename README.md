...
| `sampleData`  | `RasterSampleDataset[]` | - | Sample COGs offered as a "Load sample data" dropdown below the Add data inputs; picking one fills the URL (and attribution) input, not loaded until the user clicks Load (hidden when empty) |
